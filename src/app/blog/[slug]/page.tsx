    ...
    return (
      <MainLayout>
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="skeleton h-8 w-24 rounded-full mb-8" />
          <div className="skeleton h-12 w-3/4 rounded mb-6" />
          <div className="skeleton aspect-[21/9] rounded-3xl mb-12" />
          <div className="space-y-4"><div className="skeleton h-4 w-full rounded" /><div className="skeleton h-4 w-full rounded" /><div className="skeleton h-4 w-3/4 rounded" /></div>
        </div>
      </MainLayout>
    )
  }
